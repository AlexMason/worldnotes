...
- [x] **THEME-04**: `EditorOptions.theme` accepts a CSS string to replace the injected stylesheet entirely (full theme replacement)
- [x] **THEME-05**: Design token reference documented in `docs/theming.md`
